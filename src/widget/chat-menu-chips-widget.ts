...
import { chatMenuChipsTemplate } from './assets';
import { IChat,MessageItem } from '../models/chat.model';


export class ChatMenuChipsWidgetElement extends HTMLElement {
  ...
  constructor() {
    ...
    this.shadowRoot.appendChild(chatMenuChipsTemplate.content.cloneNode(true));
